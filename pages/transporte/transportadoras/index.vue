    ...
    <section>
        <div class="mx-auto max-w-7xl">
            <div class="mx-auto flex items-center justify-between">
                <h2 class="text-2xl font-bold text-[#1B5870]">Transportadoras</h2>
                <div class="flex gap-5">
                    <NuxtLink to="/transporte/transportadoras/create">
                                    ...
                                    <td>
                                        <el-dropdown size="large" type="primary">
                                            ...
                                            <template #dropdown>
                                                <el-dropdown-menu>
                                                    <el-dropdown-item
                                                        @click="router.push('/transporte/transportadoras/' + item.id)">
                                                        Editar
                                                    </el-dropdown-item>
