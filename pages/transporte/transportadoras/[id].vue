...
const salvar = async () => {
    ...
    router.push('/transporte/transportadoras');
};
    ...
    <div class="mx-auto max-w-5xl">
        <div class="mx-auto flex items-center justify-between">
            <h2 class="text-2xl font-bold text-[#1B5870]">
                {{ route.params.id === 'create' ? 'Novo' : 'Editar' }} transportadora
            </h2>
        </div>
        ...
        <div class="mt-6">
            <div class="grid flex-1 grid-cols-1 gap-5 pt-3 sm:grid-cols-8">
                <div class="col-span-2">
                    <label class="text-xs placeholder:text-xs" for="cpf-cnpj"> CNPJ </label>
        ...
        <div class="mt-5 flex justify-end space-x-4">
            <NuxtLink to="/transporte/transportadoras" class="btn btn-dark"> Cancelar </NuxtLink>
