...
const actionApagar = async (id: number) => {
    await updateItem({ collection: 'fornecedor', id: id, item: { status: 'draft' } });
    getFornecedores();
};

const getFornecedores = async () => {
    fornecedores.value = await getItems<any>({
        collection: "fornecedor", params: {
            filter: {
    ...
    <section>
        <div class="mx-auto max-w-7xl">
            <div class="mx-auto flex items-center justify-between">
                <h2 class="text-2xl font-bold text-[#1B5870]">Fornecedor</h2>
                <div class="flex gap-5">
                    <NuxtLink to="/compras/fornecedores/create">
            ...
            <div v-if="fornecedores.length > 0">
                <div class="table-responsive">
                    <table class="table-striped table-hover">
                        ...
                        <tbody>
                            <template v-for="item in fornecedores" :key="item.id">
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <el-dropdown size="large" type="primary">
                                            ...
                                            <template #dropdown>
                                                <el-dropdown-menu>
                                                    <el-dropdown-item
                                                        @click="router.push('/compras/fornecedores/update/' + item.id)">
                                                        Editar
                                                    </el-dropdown-item>
