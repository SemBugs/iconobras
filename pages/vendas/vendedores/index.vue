...
import type { Vendedor } from '@/types/types';

const { getItems, updateItem } = useDirectusItems();

const router = useRouter();

const results = ref<Vendedor[]>([]);

const actionApagar = async (id: number) => {
    await updateItem({ collection: 'vendedor', id: id, item: { status: 'draft' } });
    getResults();
};

const getResults = async () => {
    results.value = await getItems<any>({
        collection: "vendedor", params: {
            filter: {
    ...
    <section>
        <div class="mx-auto max-w-7xl">
            <div class="mx-auto flex items-center justify-between">
                <h2 class="text-2xl font-bold text-[#1B5870]">Vendedores</h2>
                <div class="flex gap-5">
                    <NuxtLink to="/vendas/vendedores/create">
                    ...
                    <div>
                        <div class="relative">
                            ...
                            <div
                                ...
                                <NuxtLink to="/faturarparavendedor/filtro">
                                    ...
                                    <td>
                                        <el-dropdown size="large" type="primary">
                                            ...
                                            <template #dropdown>
                                                <el-dropdown-menu>
                                                    <el-dropdown-item
                                                        @click="router.push('/vendas/vendedores/' + item.id)">
                                                        Editar
                                                    </el-dropdown-item>
