<template>
    <div class="mx-auto bg-white panel">
        <div class="mx-auto flex items-center justify-between">
            <h2 class="text-2xl font-bold">Cadastro de  Forcados de Escoras</h2>
            <button @click.prevent="isCreateForcadosOpen = true" class="btn btn-primary px-4 py-2" type="button">
        ...
        <!-- Modal -->
        <TransitionRoot appear :show="isCreateForcadosOpen" as="template">
                ...
                <div class="flex min-h-full items-center justify-center px-4 py-8">
                    <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
                        ...
                        <DialogPanel
                            ...
                            <CreateConcretoModal @close="closeForcadosModal" :tipo="'escora'" :data="form" />
                        </DialogPanel>
                    </TransitionChild>
                </div>
            </div>
...
import CreateConcretoModal from './CreateForcadoModal.vue';

const { getItems, deleteItem } = useDirectusItems();

const isCreateForcadosOpen = ref(false);
const form = ref({});
...
const editForcado = (item) => {
    console.log(item)
    form.value = item;
    isCreateForcadosOpen.value = true;
};

const closeForcadosModal = () => {
    isCreateForcadosOpen.value = false
    form.value = {}
    changeTab(0)
};
</script>