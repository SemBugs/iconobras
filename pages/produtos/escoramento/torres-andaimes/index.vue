<template>
    <div class="mx-auto bg-white panel">
        <div class="mx-auto flex items-center justify-between">
            <h2 class="text-2xl font-bold">Torres e Andaimes</h2>
            <button @click.prevent="isCreateTorresAndaimesOpen = true" class="btn btn-primary px-4 py-2" type="button">
                    ...
                    <tr v-for="(item, index) in results" :key="index">
                        ...
                        <td class="w-[60px]">
                            <div class="flex gap-5">
                                <button @click="editTorresAndaimes(item)">
        ...
        <!-- Modal -->
        <TransitionRoot appear :show="isCreateTorresAndaimesOpen" as="template">
                ...
                <div class="flex min-h-full items-center justify-center px-4 py-8">
                    <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
                        ...
                        <DialogPanel
                            ...
                            <CreateConcretoModal @close="closeTorresAndaimesModal" :tipo="selectedCategory" :data="form" />
                        </DialogPanel>
                    </TransitionChild>
                </div>
            </div>
...
import CreateConcretoModal from './CreateTorresAndaimesModal.vue';

const { getItems, deleteItem } = useDirectusItems();

const isCreateTorresAndaimesOpen = ref(false);
const form = ref({});
...
const editTorresAndaimes = (item) => {
    console.log(item)
    form.value = item;
    isCreateTorresAndaimesOpen.value = true;
};

const closeTorresAndaimesModal = () => {
    isCreateTorresAndaimesOpen.value = false
    form.value = {}
    changeTab(0)
};
</script>