...
const formFields = ref([
    ...
    createField('Diamentro', props.data.diamentro, 'select', false),
...
const addFields = () => {
    ...
    formFields.value.push(createField('Comprimento', props.data.comprimento, 'select', false))
    formFields.value.push(createField('Diamentro', props.data.diamentro, 'select', false))
    formFields.value.push(createField('Preço', parseFloat(props.data.preco).toFixed(2), 'text', false))
};
    ...
    <el-tabs v-model="activeName" type="card" class="demo-tabs" @tab-click="handleClick">
        <el-tab-pane label="Geral" name="geral">
            <h2 class="text-[#FD4C0C] font-bold mb-2">
                {{ data.id ? 'Editar Escora Usinado' : 'Cadastro de Escora' }}
            </h2>
