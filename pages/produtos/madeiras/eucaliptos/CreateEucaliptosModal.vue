...
const formFields = ref([
    ...
    createField('Diametro', props.data.diametro, 'select', false),
...
const addFields = () => {
    ...
    formFields.value.push(createField('Diametro', props.data.diametro, 'text', false))
    ...
    <el-tabs v-model="activeName" type="card" class="demo-tabs">
        <el-tab-pane label="Geral" name="geral">
            <h2 class="text-[#FD4C0C] font-bold mb-2">
                {{ data.id ? 'Editar Eucalipto' : 'Cadastro de Eucalipto' }}
            </h2>
