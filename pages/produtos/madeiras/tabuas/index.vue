<template>
    <div class="mx-auto bg-white panel">
        <div class="mx-auto flex items-center justify-between">
            <h2 class="text-2xl font-bold">Tábuas</h2>
            <button @click.prevent="isCreateTabuasOpen = true" class="btn btn-primary px-4 py-2" type="button">
        ...
        <!-- Modal -->
        <TransitionRoot appear :show="isCreateTabuasOpen" as="template">
                ...
                <div class="flex min-h-full items-center justify-center px-4 py-8">
                    <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
                        ...
                        <DialogPanel
                            ...
                            <CreateConcretoModal @close="closeTabuasModal" :tipo="selectedCategory" :data="form" />
                        </DialogPanel>
                    </TransitionChild>
                </div>
            </div>
...
import CreateConcretoModal from './CreateTabuasModal.vue';

const { getItems, deleteItem } = useDirectusItems();

const isCreateTabuasOpen = ref(false);
const form = ref({});
...
const editTabuas = (item) => {
    form.value = item;
    isCreateTabuasOpen.value = true;
};

const closeTabuasModal = () => {
    isCreateTabuasOpen.value = false
    form.value = {}
    changeTab(0)
};
</script>