<template>
    <div class="mx-auto bg-white panel">
        <div class="mx-auto flex items-center justify-between">
            <h2 class="text-2xl font-bold">Pontaletes</h2>
            <button @click.prevent="isCreatePontaletesOpen = true" class="btn btn-primary px-4 py-2" type="button">
                    ...
                    <tr v-for="(item, index) in results" :key="index">
                        ...
                        <td class="w-[60px]">
                            <div class="flex gap-5">
                                <button @click="editPontaletes(item)">
        ...
        <!-- Modal -->
        <TransitionRoot appear :show="isCreatePontaletesOpen" as="template">
                ...
                <div class="flex min-h-full items-center justify-center px-4 py-8">
                    <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
                        ...
                        <DialogPanel
                            ...
                            <CreateConcretoModal @close="closePontaletesModal" :tipo="selectedCategory" :data="form" />
                        </DialogPanel>
                    </TransitionChild>
                </div>
            </div>
...
import CreateConcretoModal from './CreatePontaletesModal.vue';

const { getItems, deleteItem } = useDirectusItems();

const isCreatePontaletesOpen = ref(false);
const form = ref({});
...
const editPontaletes = (item) => {
    form.value = item;
    isCreatePontaletesOpen.value = true;
};

const closePontaletesModal = () => {
    isCreatePontaletesOpen.value = false
    form.value = {}
    changeTab(0)
};
</script>