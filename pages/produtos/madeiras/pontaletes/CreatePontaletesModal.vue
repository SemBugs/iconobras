...
const addFields = () => {
    ...
    formFields.value.push(createField('Comprimento', props.data.tipo_peca, 'text', false))
    formFields.value.push(createField('Espessura', props.data.tipo_peca, 'text', false))
    ...
    <el-tabs v-model="activeName" type="card" class="demo-tabs">
        <el-tab-pane label="Geral" name="geral">
            <h2 class="text-[#FD4C0C] font-bold mb-2">
                {{ data.id ? 'Editar Pontaletes para Escoramento' : 'Cadastro Pontaletes para Escoramento' }}
            </h2>
