...
import type { Empresa, Cliente } from '@/types/types';
...
const salvar = async () => {
    ...
    await createItems({ collection: 'cliente', items: form.value });
    ElNotification({
        title: 'Sucesso!',
...
<template>
    <div class="mx-auto max-w-5xl">
        <div class="mx-auto flex items-center justify-between">
            <h2 class="text-2xl font-bold text-[#1B5870]">Novo cliente</h2>
        </div>
